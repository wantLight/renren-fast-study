...
public class JwtOperator {
     ...
     *
     */
    @Value("${secret:aaabbbcccdddeeefffggghhhiiijjjkkklllmmmnnnoooppsdasdassttt}")
    private String secret;
    /**
     * 有效期，单位秒
     * - 默认1天 86400 43200 21100
     */
    @Value("${expire-time-in-second:43200}")
    ...
    public static void main(String[] args) {
        ...
        jwtOperator.secret = "aaabbbcccdddeeefffggghhhiiijjjkkklllmmmnnnoooppsdasdassttt";

        // 2.设置用户信息
        HashMap<String, Object> objectObjectHashMap = Maps.newHashMap();
        objectObjectHashMap.put("userId", 1);
        objectObjectHashMap.put("role", 2);
        objectObjectHashMap.put("area", "福田区");
